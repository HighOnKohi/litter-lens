...
class ResidentMore extends StatefulWidget {
  final void Function(int) onNavigateTo;

  const ResidentMore({super.key, required this.onNavigateTo});

  @override
  State<ResidentMore> createState() => _ResidentMoreState();
}

class _ResidentMoreState extends State<ResidentMore> {
